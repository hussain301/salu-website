  ...
  const announcements = [
    {
      sr: "01",
      title:
        "Result of the test has been announced on the unversity official website",
  ...
  return (
    <div className="md:p-10 sm:p-4 p-3 w-full ">
      <div className="xl:w-[90%] mx-auto sm:w-[90%]">
        <h1 className="sm:text-4xl mt-5 sm:mt-0 text-3xl font-[500] relative after:content-[''] after:absolute after:w-8 mb-8 after:bg-[#c5c5c5] after:h-[2px] after:left-0 after:bottom-[-15px]">
            ...
            <tbody className="text-[12px  text-[#252525]  ">
              {announcements.map((announcement) => {
                return (
                  <tr
                    key={announcement.sr}
                    className="hover:bg-gray-100 transition-all cursor cursor-pointer"
                  >
                    <td className="py-4 border-t px-2 ">{announcement.sr}</td>
                    <td className="py-4 border-t md:text-sm  font-[500] text-[#01366a] px-2">
                      {announcement.title}
                    </td>
                    <td className="py-4 border-t px-2">
                      <button
