...
const pageContent = [
  ...
  },
  {
    title: "Vision",
    text: [
      "To provide policy making, skilled & legally trained Law interpreters to the different national institutions of Pakistan.",
  ...
  },
  {
    title: "Mission",
    text: [
      "To produce significant Lawyers, professionals Judges, Politicians, Solicitors equipped with virtues civic sense & sprit of duty to words the people & respect for the fundamental rights of other fellow human beings.",
    ],
  },
];
  ...
  return (
    <div className="container my-10">
      ...
      <div className="container text-center my-10">
        <h2 className="my-5">
          <strong>SCHEME OF STUDIES FOR B.A.LLB (FIVE- YEARS)</strong>
        </h2>
