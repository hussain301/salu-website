...
const pageContent = [
    {
        ...
        text:[
            ...
            {
                title:'Vision',
                text:['To prepare reflective professional educators, in order to provide service to the nation to meet the special educational challenges of the 21st century']
            },
            {
                title:'Mission',
                text:['To prepare teachers to bring effective contributions in the field of Special Education for the special persons.']
            },
            {
...
SEMESTER WISE SCHEME OF STUDIES
        ...
        <h2 className='mt-5 text-blue-500'>
          <strong>
            SYLLABUS FOR MA (TWO YEARS) IN SPECIAL EDUCATION
SEMESTER WISE SCHEME OF STUDIES
          </strong>
        </h2>
        <div className="flex justify-center">
