...
const Model = () => {
    return (
        <div><div className="text-center">
            <button type="button" className="border-2 rounded-md md:text-sm text-[#01366a] border-blue-900 py-2 px-4 font-[500] 
                            ...
                            <div className="sm:divide-y divide-gray-200 dark:divide-gray-700">
                                <div className="py-3 sm:py-6">
                                    ...
                                    <div className="grid gap-2 sm:grid-cols-2 md:grid-cols-3">
                                        {/* <!-- Card --> */}
                                        <a className="bg-white p-4 transition duration-300 rounded-md hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-white/[.05]" href="../docs/frameworks-vuejs.html">
                                            <div className="flex">
                                                <div className="mt-1.5 flex justify-center flex-shrink-0 rounded-l-xl">
                                                    <svg className="w-5 h-5 text-gray-800 dark:text-gray-200" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                        ...
                                        <a className="bg-white p-4 transition duration-300 rounded-md hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-white/[.05]" href="../docs/frameworks-vuejs.html">
                                            <div className="flex">
                                                <div className="mt-1.5 flex justify-center flex-shrink-0 rounded-l-xl">
                                                    <svg className="w-5 h-5 text-gray-800 dark:text-gray-200" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                        ...
                                        <a className="bg-white p-4 transition duration-300 rounded-md hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-white/[.05]" href="../docs/frameworks-vuejs.html">
                                            <div className="flex">
                                                ...
                                                <div className="grow ml-6">
                                                    <h3 className="text-sm font-semibold text-blue-600 dark:text-blue-500">
                                                        Mega Menu <span className="ml-1 inline bg-blue-50 border border-blue-300 text-blue-600 text-[.6125rem] leading-4 uppercase rounded-full py-0.5 px-2 dark:bg-blue-900/[.75] dark:border-blue-700 dark:text-blue-500">Hot</span>
                                                    </h3>
                                                    <p className="mt-1 text-sm text-gray-600 dark:text-gray-500">
                                                        A framework for building web user interfaces.
                                                    </p>
                                ...
                                <div className="py-3 sm:py-6">
                                    ...
                                    <div className="grid gap-2 sm:grid-cols-2 md:grid-cols-3">
                                        ...
                                        <a className="bg-white p-4 transition duration-300 rounded-md hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-white/[.05]" href="../docs/frameworks-vuejs.html">
                                            <div className="flex">
                                                ...
                                                <div className="grow ml-6">
                                                    <h3 className="text-sm font-semibold text-blue-600 dark:text-blue-500">
                                                        Sidebar <span className="ml-1 inline bg-blue-50 border border-blue-300 text-blue-600 text-[.6125rem] leading-4 uppercase rounded-full py-0.5 px-2 dark:bg-blue-900/[.75] dark:border-blue-700 dark:text-blue-500">New</span>
                                                    </h3>
                                                    <p className="mt-1 text-sm text-gray-600 dark:text-gray-500">
                                                        A framework for building web user interfaces.
                                                    </p>
                                    ...
                                    <p className="mt-4 text-xs text-gray-500">
                                        Completely unstyled, fully accessible UI <a className="inline-flex items-center gap-x-1.5 text-blue-600 decoration-2 hover:underline font-medium" href="../plugins.html">plugins</a> for popular features that for one reason or another dont belong in core.
                                    </p>
                                </div>
                            </div>
                        </div>
