  ...
  return (
    <div>
      <div className="text-center">
        <button
          type="button"
          className="border-2 rounded-md md:text-sm text-[#01366a] border-blue-900 py-2 px-4 font-[500] 
              ...
              <div className="sm:divide-y divide-gray-200 dark:divide-gray-700">
                <div className="py-3 sm:py-6">
                  ...
                  <div className="grid gap-2 sm:grid-cols-2 md:grid-cols-3">
                    {/* <!-- Card --> */}
                    <a
                      className="bg-white p-4 transition duration-300 rounded-md hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-white/[.05]"
                    ...
                    >
                      <div className="flex">
                        ...
                        <div className="grow ml-6">
                          <h3 className="text-sm font-semibold text-blue-600 dark:text-blue-500">
                            Mega Menu{" "}
                            <span className="ml-1 inline bg-blue-50 border border-blue-300 text-blue-600 text-[.6125rem] leading-4 uppercase rounded-full py-0.5 px-2 dark:bg-blue-900/[.75] dark:border-blue-700 dark:text-blue-500">
                              Hot
                            </span>
                          </h3>
                          <p className="mt-1 text-sm text-gray-600 dark:text-gray-500">
                ...
                <div className="py-3 sm:py-6">
                  ...
                  <p className="mt-4 text-xs text-gray-500">
                    ...
                    for popular features that for one reason or another dont
                    belong in core.
                  </p>
                </div>
              </div>
