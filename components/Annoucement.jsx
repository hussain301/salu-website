...
const Annoucement = () => {
  const announcements = [
    { sr: '01', title: 'Carrier Opportunities: Teaching Assistants (Botany, Sindhi and Physics) Required for SALU ', dateOfAnnouncement: '2022-09-11', lastDate: '2023-01-01' },
  ...
  return (
    <div className='relative bg-blue-500/20 m-2 text-center rounded-md'>
            ...
            <table className="table-auto text-left w-full  whitespace-nowrap md:whitespace-normal">
              ...
              <tbody className='text-[12px]  text-[#252525]  '>
                {announcements.map(announcement => {
                  return (
                    <tr className='hover:bg-gray-100 transition-all cursor cursor-pointer'>
      ...
      {/* <Link href='/announcements' className='text-white font-bold text-3xl '>Important Annoucements</Link> */}
    </div>
  )
}
