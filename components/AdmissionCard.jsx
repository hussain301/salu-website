...
const AdmissionCard = () => {
  const data = [
    {
      title: "Procedure & Eligibility Criteria",
      url: "https://salu.edu.pk/wp-content/uploads/2021/03/first.png",
      icon: <FaHamburger />,
    },
    {
      title: "Scholarships & Financial Support",
      url: "https://salu.edu.pk/wp-content/uploads/2021/03/WhatsApp-Image-2021-02-15-at-8.46.21-PM.jpeg",
      icon: <IoSchool />,
    },
    {
      title: "Semester Rules & Regulations",
      url: "https://salu.edu.pk/wp-content/uploads/2021/03/salupic.jpeg",
      icon: <FaCheckDouble />,
    },
  ];
  return (
          ...
          {data.map((item, i) => {
            return (
              <div
                ...
                className="lg:w-[300px] lg:h-[470px] group xl:w-[370px] xl:h-[450px] relative flex items-center justify-center rounded-md md:w-[280px] mx-auto h-[350px] w-[90%] bg-cover bg-center "
              >
