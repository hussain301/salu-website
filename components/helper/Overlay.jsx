...
const Overlay = (props) => {
  ...
  return (
    ...
    style={{ backgroundImage: `${props.url ? `url(${props.url})` : '' }` }}
      className={` ${props.gradient && props.gradient} relative leading-10 flex justify-center items-center bg-no-repeat bg-fixed object-contain bg-cover bg-center h-[300px]`}
    >
