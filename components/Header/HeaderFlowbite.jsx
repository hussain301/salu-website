      ...
      <div className="flex gap-2 px-3 justify-between items-center text-lg font-medium uppercase">
        ...
        <ul className="text-sm capitalize justify-end flex gap-2 sm:gap-5 px-3 items-center  ">
          {links.map((link, index) => (
            <li
              key={index}
              className=" hover:text-blue-600 cursor-pointer px-3 sm:p-0 sm:mt-0 transition-all duration-300 text-[#a1a4bb]"
            >
      ...
      >
        <div className="flex items-center justify-end">
          ...
          <div className="sm:hidden">
            <button
              type="button"
              className="hs-collapse-toggle p-2 inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-white text-[#5b6088] shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm "
        ...
        >
          <div className="flex  flex-col  sm:gap-5 mt-5 sm:flex-row sm:items-center sm:justify-center sm:mt-0 sm:pl-5">
              ...
              return (
                ...
                >
                  ...
                  >
                    {item.name}
                    <svg
                      className="ml-2 group-hover:text-blue-600 transition-all duration-300 w-2.5 h-2.5 text-[#a1a4bb]"
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                      fill="none"
            ...
            <Link
              className="font-medium hover:text-blue-600 mt-1 sm:mt-0 sm:p-0 px-5 transition-all duration-300  text-[#a1a4bb] "
              href="#"
            >
              Central Library
            </Link>
            <Link
              className="font-medium hover:text-blue-600 mt-2 px-5 sm:p-0 sm:mt-0 transition-all duration-300 text-[#a1a4bb]  "
              href="#"
            >
              Gallery
            </Link>
